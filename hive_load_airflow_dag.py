...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistics_raw_data/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistics_raw_data/input_data/logistics_*.csv gs://logistics_archive_data/",
    dag=dag
)y
